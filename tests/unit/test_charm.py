...
from charm import SERVICE_NAME, VernemqOperatorCharm
...
def test_pebble_ready(monkeypatch: pytest.MonkeyPatch):
    ...
    # Arrange:
    ctx = testing.Context(VernemqOperatorCharm)
    ...
    monkeypatch.setattr("charm.vernemq.get_version", mock_get_version)
